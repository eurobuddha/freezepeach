...
public interface CryptoProvider {
    ...
    /** Detached Ed25519 signature over {@code message} with my signing key (hex) — used to authenticate
     *  to a mailbox (prove I own this identity) when reading or deleting my own mail. */
